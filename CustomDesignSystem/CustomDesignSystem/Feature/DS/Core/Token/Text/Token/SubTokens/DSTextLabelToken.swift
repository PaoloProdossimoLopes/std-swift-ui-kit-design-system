class DSTextLabelToken: DSTokenProtocol {
    ...
    static func setupSize(_ component: Component, size: Variant.Size) {
        ...
        switch textWeight {
        case .thin:
            tokenTextFont = .ds_font_01_thin
        case .light:
            tokenTextFont = .ds_font_01_light
        case .regular:
            tokenTextFont = .ds_font_01_regular
        case .medium:
            tokenTextFont = .ds_font_01_medium
        case .demibold:
            tokenTextFont = .ds_font_01_demibold
        case .bold:
            tokenTextFont = .ds_font_01_bold
        case .black:
            tokenTextFont = .ds_font_01_black
        case .heavy:
            tokenTextFont = .ds_font_01_heavy
        }
        
        component.textFont = tokenTextFont.font
    }
}
